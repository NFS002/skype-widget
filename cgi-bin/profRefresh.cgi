...
newAvailabilityLine = val3 + "," + val4  + '\n'

availabilityFile = open('availability/availability.csv','a')
availabilityFile.write(newAvailabilityLine)
